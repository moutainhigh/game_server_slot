...
public class RobotMessageMappingProvider {
	...
	public static final short[] msgTypes = new short[]{
		...
		MessageType.GC_BANK_SET_PASSWORD,
		...
		MessageType.GC_BANK_MAKE_SURE_IDENTIFYING_CODE,
		...
		MessageType.GC_SEND_FINISH,
		MessageType.GC_LOAD_SEND_LIST,
		...
		MessageType.GC_BANK_CHANGE_PASSWORD,
		MessageType.GC_BANK_SEND_IDENTIFYING_CODE,
	...
	public static void fill(Map<Short, Class<?>> msgs) {
		...
		msgs.put(MessageType.GC_BANK_VIEW, GCBankView.class);
		...
		msgs.put(MessageType.GC_BANK_STATE, GCBankState.class);
		...
		msgs.put(MessageType.GC_BANK_SET_PASSWORD, GCBankSetPassword.class);
		...
		msgs.put(MessageType.GC_BANK_MAKE_SURE_IDENTIFYING_CODE, GCBankMakeSureIdentifyingCode.class);
		...
		msgs.put(MessageType.GC_SEND_FINISH, GCSendFinish.class);
		msgs.put(MessageType.GC_LOAD_SEND_LIST, GCLoadSendList.class);
		...
		msgs.put(MessageType.GC_BANK_CHANGE_PASSWORD, GCBankChangePassword.class);
		msgs.put(MessageType.GC_BANK_SEND_IDENTIFYING_CODE, GCBankSendIdentifyingCode.class);
