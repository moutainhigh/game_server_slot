...
public class LangConstants {
	...
	@SysI18nString(content = "用户混合")
	public static final Integer USER_MIX = ++USER_BASE;
	...
	@SysI18nString(content = "银行的密码输入错误")
	public static final Integer BANK_PASSWORD_IS_WRONG = ++BANK_BASE;
	@SysI18nString(content = "银行  老密码 与 新密码 不能相等")
	public static final Integer BANK_PASSWORD_NEW_EQUALS_OLD = ++BANK_BASE;
	@SysI18nString(content = "银行的密码与老密码不相等")
	public static final Integer BANK_PASSWORD_IS_NOT_EQUALS_OLD = ++BANK_BASE;
	@SysI18nString(content = "银行密码  只能输 入英文和数字")
	public static final Integer BANK_PASSWORD_IS_NOT_NUMBER_OR_ZIMU = ++BANK_BASE;
	@SysI18nString(content = "输入金币不能为0或者小于0")
	public static final Integer BANK_GOLD_IS_ZERO = ++BANK_BASE;
	@SysI18nString(content = "金币不足")
	public static final Integer BANK_GOLD_IS_NOT_ENOUGH = ++BANK_BASE;
	@SysI18nString(content = "验证码不能为空")
	public static final Integer BANK_IDENTIFYING_CODE_IS_NULL = ++BANK_BASE;
	@SysI18nString(content = "验证码不匹配")
