...
public class Human extends Role implements PersistanceObject<Long, HumanEntity>, RoleDataHolder {
	...
	/**代理**/
	private BazooAgentEntity bazooAgentEntity;
	/**用户**/
	...
	public void fromEntity(HumanEntity entity) {
		...
		//同时 把userInfo 也加载进来
		bazooAgentEntity= Globals.getDaoService().getBazooAgentDao().getTheAgent(String.valueOf(entity.getPassportId()));
...
//				ItemTemplate itemTemplate2 = Globals.getItemService().getItemTemplWithId(levelGift.getReward3Id());
	...
	public BazooAgentEntity getBazooAgentEntity() {
		return bazooAgentEntity;
	}

	public void setBazooAgentEntity(BazooAgentEntity bazooAgentEntity) {
		this.bazooAgentEntity = bazooAgentEntity;
	}
