...
import com.db.dao.BazooAgentDao;
...
public final class GameDaoService
{
	...
	public BazooAgentDao getBazooAgentDao() {
		return daoHelper.bazooAgentDao;
	}
	...
	private static final class DaoHelper
	{
		...
		/**用户之间发送礼物  **/
		private final BazooAgentDao bazooAgentDao;
		/**用户**/
		...
		private DaoHelper(GameServerConfig config){
			...
			bazooAgentDao = new BazooAgentDao(dbService);
