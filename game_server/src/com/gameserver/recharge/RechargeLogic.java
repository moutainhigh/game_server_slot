...
public class RechargeLogic {
	...
	private static boolean buyGold(Player player,Human human,HumanRechargeOrder order,int cost, RechargeTemplate rechargeTemplate){
		...
		/**
	  	 ...
	  	 */
	  	if(!(categoryEnum == CategoryEnum.CATEGORYENUM3 && rechargeTemplate.getSmallCategory() == SmallCategoryEnum.SMALLCATEGORYENUM14.getIndex())
	  			&& !(categoryEnum == CategoryEnum.CATEGORYENUM3 && rechargeTemplate.getSmallCategory() == SmallCategoryEnum.SMALLCATEGORYENUM15.getIndex())
	  			&& !(categoryEnum == CategoryEnum.CATEGORYENUM3 && rechargeTemplate.getSmallCategory() == SmallCategoryEnum.SMALLCATEGORYENUM11.getIndex())){
	  		//计算VIP加成
	  		VipNewServer server = Globals.getVipNewServer();
	  		diamondAdd = server.getBuyGoldBylv(human.getHumanVipNewManager().getVipLv(),diamondAdd);
...
//			}
		...
		if( !(rechargeTemplate.getCategory() == CategoryEnum.CATEGORYENUM4.getIndex()) || !(rechargeTemplate.getSmallCategory() == SmallCategoryEnum.SMALLCATEGORYENUM10.getIndex())){
			/**
			 * 是否是周月礼包
			 */
			boolean isWeekOrMonth =false;
			if(categoryEnum == CategoryEnum.CATEGORYENUM3 && 
					(rechargeTemplate.getSmallCategory() == SmallCategoryEnum.SMALLCATEGORYENUM14.getIndex() 
						|| rechargeTemplate.getSmallCategory() == SmallCategoryEnum.SMALLCATEGORYENUM15.getIndex())){
				isWeekOrMonth=true;
			}
			/**
    	...
    	//奖励vip点 
	  	...
	  	if(categoryEnum == CategoryEnum.CATEGORYENUM3 ){
	  		  if(smallCategoryEnum == SmallCategoryEnum.SMALLCATEGORYENUM11){
	  	 ...
	  	 * 月特惠礼包  如果购买一次就关闭
	  	 */
	  	if(categoryEnum == CategoryEnum.CATEGORYENUM3 && rechargeTemplate.getSmallCategory() == SmallCategoryEnum.SMALLCATEGORYENUM15.getIndex()){
	...
	public void giveTheThing(Player player,long orderId,int cost){
		    ...
		    //物品
		    	...
		    	//月卡
		    	}else if(smallCategrory == SmallCategoryEnum.SMALLCATEGORYENUM3.getIndex()){
		    		
		    	}else if(smallCategrory == SmallCategoryEnum.SMALLCATEGORYENUM5.getIndex()){
		    		
		    	}else if(smallCategrory == SmallCategoryEnum.SMALLCATEGORYENUM8.getIndex()){
		    		
		    	}else if(smallCategrory == SmallCategoryEnum.SMALLCATEGORYENUM12.getIndex()){
		    		
		    	}else if(smallCategrory == SmallCategoryEnum.SMALLCATEGORYENUM13.getIndex()){
		    		
		    	}
		    //礼包
		    }else if(categrory == CategoryEnum.CATEGORYENUM3.getIndex()){
		    	if(smallCategrory == SmallCategoryEnum.SMALLCATEGORYENUM11.getIndex()){
		    		
		    	//周 特惠礼包
		    	}else if(smallCategrory == SmallCategoryEnum.SMALLCATEGORYENUM14.getIndex()){
		    		buyMailIWeekAndMonthGold(player,human,order,cost,rechargeTemplate);
		    		
	    		//月 特惠礼包
		    	}else if(smallCategrory == SmallCategoryEnum.SMALLCATEGORYENUM15.getIndex()){
		    		buyMailIWeekAndMonthGold(player,human,order,cost,rechargeTemplate);
		    		
		    	}
		    //功能性付费
		    }else if(categrory == CategoryEnum.CATEGORYENUM4.getIndex()){
		    	if(smallCategrory == SmallCategoryEnum.SMALLCATEGORYENUM6.getIndex()){
		    		
		    	}else if(smallCategrory == SmallCategoryEnum.SMALLCATEGORYENUM7.getIndex()){
		    		
		    	}else if(smallCategrory == SmallCategoryEnum.SMALLCATEGORYENUM9.getIndex()){
		    		
		    	}else if(smallCategrory == SmallCategoryEnum.SMALLCATEGORYENUM10.getIndex()){
	...
	private boolean buyMailIWeekAndMonthGold(Player player,Human human,HumanRechargeOrder order,int cost, RechargeTemplate rechargeTemplate) {
		...
		sendRechargeLog(human,order,order.getCost());
	  	 ...
	  	 * 周特惠礼包  如果购买一次就关闭
	  	 */
	  	if(rechargeTemplate.getSmallCategory() == SmallCategoryEnum.SMALLCATEGORYENUM14.getIndex()){
	  		human.getHumanRegularTimeManager().changeIsBuy(0,rechargeTemplate);
	  	}
	  	/**
	  	 * 月特惠礼包  如果购买一次就关闭
	  	 */
	  	if(rechargeTemplate.getSmallCategory() == SmallCategoryEnum.SMALLCATEGORYENUM15.getIndex()){
	  		human.getHumanRegularTimeManager().changeIsBuy(1,rechargeTemplate);
	  	}
