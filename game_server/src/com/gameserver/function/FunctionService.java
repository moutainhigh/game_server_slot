...
//				int smallCategory = Integer.valueOf(conditionArr[1]).intValue();
				...
				if(!ok){
				  ...
				  if(rechargeTemplate.getCategory() == CategoryEnum.CATEGORYENUM2.getIndex() &&
						  rechargeTemplate.getSmallCategory() == SmallCategoryEnum.SMALLCATEGORYENUM12.getIndex()){
				   ...
				   */
				  if(rechargeTemplate.getCategory() == CategoryEnum.CATEGORYENUM2.getIndex() &&
						  rechargeTemplate.getSmallCategory() == SmallCategoryEnum.SMALLCATEGORYENUM3.getIndex() ){
