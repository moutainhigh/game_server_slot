...
public class MailMsgMappingProvider implements MessageMappingProvider {
	...
	public Map<Short, Class<?>> getMessageMapping() {
		...
		map.put(MessageType.CG_LOAD_SEND_LIST, CGLoadSendList.class);
		...
		map.put(MessageType.CG_DELETE_SEND_MAIL, CGDeleteSendMail.class);
		map.put(MessageType.CG_DELETE_SEND_CANCEL_MAIL, CGDeleteSendCancelMail.class);
