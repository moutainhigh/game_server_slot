 ...
 */
public class CGDeleteSendMail extends CGMessage{
	
	/** 邮件Id列表 */
	private long[] mailIdList;
	
	public CGDeleteSendMail (){
	}
	...
	public short getType() {
		return MessageType.CG_DELETE_SEND_MAIL;
	}
	
	@Override
	public String getTypeName() {
		return "CG_DELETE_SEND_MAIL";
	}
	...
	@Override
	public void execute() {
		MailHandlerFactory.getHandler().handleDeleteSendMail(this.getSession().getPlayer(), this);
	}
}