...
public class GCUpdateMailList extends GCMessage{
	...
	protected boolean readImpl() {
		...
		mailInfoData = new com.gameserver.mail.data.MailInfoData();
					mailInfoData.setMailId(readLong());
							...
							mailInfoData.setReceiveId(readLong());
							mailInfoData.setReceiveName(readString());
							mailInfoData.setGold(readLong());
	...
	protected boolean writeImpl() {
		...
		writeLong(mailInfoData.getReceiveId());
		writeString(mailInfoData.getReceiveName());
		writeLong(mailInfoData.getGold());
