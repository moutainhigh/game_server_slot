...
public class MailLogic {
	...
	public void deleteSendMails(Player player, long[] mailIds) {
		// TODO Auto-generated method stub
		for(long mailId:mailIds)
		{
	...
	public boolean checkReceiveMailDelete(Player player, long[] mailIds) {
		// TODO Auto-generated method stub
		for(long mailId:mailIds)
		{
			Mail mail=player.getHuman().getHumanMailManager().getMailDataByMailId(mailId);
	 ...
	 * @return
	 */
	public boolean checkSendMailDelete(Player player, long[] mailIds) {
		// TODO Auto-generated method stub
		for(long mailId:mailIds)
		{
			Mail mail=player.getHuman().getHumanMailManager().getSendMailDataByMailId(mailId);
	...
	public Mail getSendMail(Player player, long mailId) {
		return player.getHuman().getHumanMailManager().getSendMailDataByMailId(mailId);
	}
	...
	public void receiveMail(Human human, MailEntity mailEntity) {
		...
		humanMailManager.getReceiveMailList().add(0, mail);
		////send msg 
